    ...
    BX.CFileInput.prototype.Callback = function (files, uniqueID)
    {
        ...
        for (var i = 0; i < files.length; i++)
        {
            ...
            } else
            {
                ...
                let parentError = document.getElementById(elem.id);
                let errorContainer = document.createElement('div');
                errorContainer.innerHTML = files[i].error + ' Он не будет отправлен! Удалите файл!';
                errorContainer.classList.add('error_file_upload');
                parentError.appendChild(errorContainer);
