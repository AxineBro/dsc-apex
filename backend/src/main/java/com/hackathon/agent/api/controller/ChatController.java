...
public class ChatController {
     ...
     * контроллер генерирует новый идентификатор сессии (UUID) и передаёт его в
     * {@link ChatFacade#processMessageRich}. Непосредственное создание сессии
     * выполняется ниже по цепочке — в {@code SessionManager#getOrCreate}.
